...
const jobsStaticData = [
  {
    node: {
      ...
      html: `<ul><li>Collaborated on building backend services and APIs with Python, FastAPI and Celery, using SQLAlchemy for database interactions</li><li>Containerized applications with Docker, managed Postgres databases, and implemented CI/CD pipelines using Github Actions</li><li>Worked with a team to develop cross-platform mobile apps with React Native</li><li>Focused on scalable backend architecture and modern development practices</li></ul>`
    }
  },
  {
    node: {
  ...
  },
  {
    node: {
      frontmatter: {
        ...
        url: 'https://kartaca.com/'
      },
      html: `<ul><li>Worked on upgrading an LDAP service which is used by company to the latest version</li><li>Managed OpenLDAP configurations and ensured smooth migration</li></ul>`
    }
  },
  {
    node: {
      ...
      html: `<ul><li>Worked on a Subscription Lifecycle Management System that integrates with 3rd party applications</li><li>Developed backend services using Java and Spring framework</li><li>Implemented API integrations for subscription management workflows</li></ul>`
    }
  }
];

const Jobs = () => {
  const jobsData = jobsStaticData;
